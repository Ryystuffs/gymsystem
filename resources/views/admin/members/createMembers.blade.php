            ...
            <div class="bg-[#292626] p-8 rounded-lg shadow-md">
                ...
                <form method="POST" action="{{ route('admin.members.store') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="date" id="duration" name="expired_at" placeholder="Duration in days"
                            class="input-design" value="" required readonly>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="number" id="amount_paid" name="amount" placeholder="Amount Paid"
