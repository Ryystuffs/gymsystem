            ...
            <div class="flex min-h-screen relative">
                ...
                >
                    ...
                    <nav class="flex-1 px-4 space-y-2">
                        ...
                        <a href="{{ route('dashboard') }}" class="flex items-center gap-3 px-3 py-3 rounded-xl transition-all group/item {{ request()->routeIs('dashboard')
                        ...
                        <a href="{{ route('membership-plans.list') }}" class="flex items-center gap-3 px-3 py-3 rounded-xl transition-all group/item {{ request()->routeIs('membership-plans.list')
                            ? ' bg-white/10 text-white  border border-white/10  hover:bg-white/20 ' 
                            : 'text-red-100/70 hover:text-white hover:bg-white/5' }}" >
                            <div class="shrink-0">
                                <svg stroke="currentColor" class="h-5 w-5 {{ request()->routeIs('membership-plans.list') ? 'nav-active' : 'nav' }}" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="{{ route('scanner') }}" class="flex items-center gap-3 px-3 py-3 rounded-xl transition-all group/item {{ request()->routeIs('scanner')
                            ? ' bg-white/10 text-white  border border-white/10  hover:bg-white/20 ' 
                            : 'text-red-100/70 hover:text-white hover:bg-white/5' }}" >
                            <div class="shrink-0">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 {{ request()->routeIs('scanner') ? 'nav-active' : 'nav' }}" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" >
                        ...
                        <a href="{{ route('walkin.session') }}" class="flex items-center gap-3 px-3 py-3 rounded-xl transition-all group/item {{ request()->routeIs('walkin.session')
                            ? ' bg-white/10 text-white  border border-white/10  hover:bg-white/20 ' 
                            : 'text-red-100/70 hover:text-white hover:bg-white/5' }}" >
                            <div class="shrink-0">
                                <svg height="24" width="24" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 {{ request()->routeIs('walkin.session') ? 'nav-active' : 'nav' }}" viewBox="0 0 256 256" fill="currentColor">
                        ...
                        <a href="{{ route('members.list') }}" class="flex items-center gap-3 px-3 py-3 rounded-xl transition-all group/item {{ request()->routeIs('members.list')
                            ? ' bg-white/10 text-white  border border-white/10  hover:bg-white/20 ' 
                            : 'text-red-100/70 hover:text-white hover:bg-white/5' }}" >
                            <div class="shrink-0">
                                <svg stroke="currentColor" fill="none" class="h-5 w-5 {{ request()->routeIs('members.list') ? 'nav-active' : 'nav' }}" xmlns="http://www.w3.org/2000/svg" id="mdi-wallet-membership" viewBox="0 0 24 24">
                        ...
                        <a href="{{ route('members.session') }}" class="flex items-center gap-3 px-3 py-3 rounded-xl transition-all group/item {{ request()->routeIs('members.session')
                            ? ' bg-white/10 text-white  border border-white/10  hover:bg-white/20 ' 
                            : 'text-red-100/70 hover:text-white hover:bg-white/5' }}" >
                            <div class="shrink-0">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 {{ request()->routeIs('members.session') ? 'nav-active' : 'nav' }}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <a href="{{ route('payment-record') }}" class="flex items-center gap-3 px-3 py-3 rounded-xl transition-all group/item {{ request()->routeIs('payment-record')
                            ? ' bg-white/10 text-white  border border-white/10  hover:bg-white/20 ' 
                            : 'text-red-100/70 hover:text-white hover:bg-white/5' }}" >
                            <div class="shrink-0">
                                <svg class="h-5 w-5 {{ request()->routeIs('payment-record') ? 'nav-active' : 'nav' }}" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <main class="flex-1 min-w-0 min-h-screen bg-[#242424]">
                    <header class="h-20 bg-[#242424] border-b border-white/5 flex justify-between items-center px-8 sticky top-0 z-20">
                        ...
                        <h2 class="text-2xl font-bold text-white"> @yield('pageTitle', '')</h2>                        
                        {{-- <div>
