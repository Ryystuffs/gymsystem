<x-membernav>
    <div class="flex flex-col min-h-screen items-center justify-center px-4 py-2 bg-white">
            <div
        ...
        <div class="bg-white text-gray-800 p-6 mt-6 w-full max-w-md">
            <h3 class="text-xl sm:text-2xl font-semibold mb-3 text-black">Directions for Use:</h3>
            <ol class=" space-y-2 text-base sm:text-lg ">
                ...
                <li>3. When leaving the gym, scan the same QR code again at the exit scanner to record your check-out
                    time.</li>
            </ol>
        </div>
